...
public class TaskController {
    // making an instance of Database Connection
    ...
    // Controller to add  attributes in Job Table
    ...
    // fetch job attributes from Job Table
    ...
    // fetch source task and destination task from jobTask Table
   ...
   public TaskModel getTaskById(Integer id){
    ...
    // fetch all the attributes from JobTable
